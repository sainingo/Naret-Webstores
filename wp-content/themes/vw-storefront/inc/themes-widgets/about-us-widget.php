...
class vw_storefront_About_Widget extends WP_Widget {
	function __construct() {
		parent::__construct(
			'vw_storefront_About_Widget',
			__('VW About us', 'vw-storefront'),
			array( 'description' => __( 'Widget for about us section in sidebar', 'vw-storefront' ), ) 
		);
	}
	...
	?>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('author')); ?>"><?php esc_html_e('Author Name:','vw-storefront'); ?></label>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('designation')); ?>"><?php esc_html_e('Designation:','vw-storefront'); ?></label>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('description')); ?>"><?php esc_html_e('Description:','vw-storefront'); ?></label>
    	...
    	<p>
		<label for="<?php echo esc_attr($this->get_field_id('read_more_text')); ?>"><?php esc_html_e('Button Text:','vw-storefront'); ?></label>
		...
		<p>
		<label for="<?php echo esc_attr($this->get_field_id('read_more_url')); ?>"><?php esc_html_e('Button Url:','vw-storefront'); ?></label>
		...
		<p>
		<label for="<?php echo esc_attr($this->get_field_id( 'upload_image' )); ?>"><?php esc_html_e( 'Image Url:','vw-storefront'); ?></label>
		<?php
			if ( $upload_image != '' ) :
...
function vw_storefront_about_custom_load_widget() {
	register_widget( 'vw_storefront_About_Widget' );
}
add_action( 'widgets_init', 'vw_storefront_about_custom_load_widget' );