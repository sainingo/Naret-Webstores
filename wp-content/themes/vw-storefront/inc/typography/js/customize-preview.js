jQuery( document ).ready( function() {
	...
	wp.customize(
		'vw_storefront_p_letter_spacing',
		function( value ) {
			value.bind( 
				function( to ) {
	...
	wp.customize(
		'vw_storefront_a_letter_spacing',
		function( value ) {
			value.bind( 
				function( to ) {
	...
	wp.customize(
		'vw_storefront_h1_letter_spacing',
		function( value ) {
			value.bind( 
				function( to ) {
	...
	wp.customize(
		'vw_storefront_h2_letter_spacing',
		function( value ) {
			value.bind( 
				function( to ) {
	...
	wp.customize(
		'vw_storefront_h3_letter_spacing',
		function( value ) {
			value.bind( 
				function( to ) {
	...
	wp.customize(
		'vw_storefront_vw_storefront_h4_font_size',
		function( value ) {
			value.bind( 
				function( to ) {
	...
	wp.customize(
		'vw_storefront_vw_storefront_h4_line_height',
		function( value ) {
			value.bind( 
				function( to ) {
	...
	wp.customize(
		'vw_storefront_vw_storefront_h4_letter_spacing',
		function( value ) {
			value.bind( 
				function( to ) {
	...
	wp.customize(
		'vw_storefront_vw_storefront_h5_font_color',
		function( value ) {
			value.bind( 
				function( to ) {
	...
	wp.customize(
		'vw_storefront_vw_storefront_h5_font_family',
		function( value ) {
			value.bind( 
				function( to ) {
	...
	wp.customize(
		'vw_storefront_h5_letter_spacing',
		function( value ) {
			value.bind( 
				function( to ) {
	...
	wp.customize(
		'vw_storefront_h6_letter_spacing',
		function( value ) {
			value.bind( 
				function( to ) {
