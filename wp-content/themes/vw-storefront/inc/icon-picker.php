...
class VW_Storefront_Fontawesome_Icon_Chooser extends WP_Customize_Control{
    public $type = 'icon';
    ...
    public function render_content(){ ?>
        <label>
            ...
            <div class="social-icon-search">
                <input class="socialInput" type="text" placeholder="<?php echo esc_attr_x( 'Icon', 'placeholder', 'vw-storefront' ); ?>">
            </div>
            ...
            <ul class="icon-list clearfix">
                <?php
                $vw_storefront_font_awesome_icon_array = vw_storefront_font_awesome_icon_array();
                foreach ($vw_storefront_font_awesome_icon_array as $vw_storefront_font_awesome_icon) {
                        $icon_class = $this->value() == $vw_storefront_font_awesome_icon ? 'icon-active' : '';
                        echo '<li class='.esc_attr($icon_class).'><i class="'.esc_attr($vw_storefront_font_awesome_icon).'"></i>
                        <span class="vw-storefront-social-class">'.esc_attr($vw_storefront_font_awesome_icon).'</span>
                        </li>';
                    }
                ?>
            </ul>
...
function vw_storefront_customizer_script() {
     
    wp_enqueue_style( 'font-awesome-1', esc_url(get_template_directory_uri()).'/assets/css/fontawesome-all.css');
    wp_enqueue_script( 'vw-storefront-customizer-script', esc_url(get_template_directory_uri()).'/assets/js/customizer-scripts.js', array("jquery"),'', true  );
}
add_action( 'customize_controls_enqueue_scripts', 'vw_storefront_customizer_script' );

if(!function_exists('vw_storefront_font_awesome_icon_array')){
    function vw_storefront_font_awesome_icon_array(){
